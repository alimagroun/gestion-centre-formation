...
public class RegistrationMapper {
    ...
    public RegistrationResponse toResponse(Registration registration) {
        ...
        return RegistrationResponse.builder()
                                   ...
                                   .studentId(registration.getStudent()
                                                          .getId())
                                   .fullNameStudent(registration.getStudent()
                                                                .getFirstName() + ' ' + registration.getStudent()
                                                                                                    .getLastName())
                                   .specialtyId(registration.getSpecialty()
                                                            .getId())
                                   .specialtyName(registration.getSpecialty()
                                                              .getFormationType()
                                                              .getName() + "-" + registration.getSpecialty()
                                                                                             .getDomaine()
                                                                                             .getName())
                                   .build();
    }
    ...
    public RegistrationDetailsResponse toRegistrationResponse(Registration registration) {
        ...
        details.setSpecialtyName(registration.getSpecialty()
                                             .getFormationType()
                                             .getName() + "-" + registration.getSpecialty()
                                                                            .getDomaine()
                                                                            .getName());
        details.setSpecialtyId(registration.getSpecialty()
                                           .getId());
        ...
        details.setStudent(
                StudentDetails.builder()
                              .id(registration.getStudent()
                                              .getId())
                              .fullName(registration.getStudent()
                                                    .getFirstName() + ' ' + registration.getStudent()
                                                                                        .getLastName())
                              .levelOfEducation(registration.getStudent()
                                                            .getLevelOfEducation())
                              .phoneNumber(registration.getStudent()
                                                       .getPhoneNumber())
                              .email(registration.getStudent()
                                                 .getEmail())
                              .identityNumber(registration.getStudent()
                                                          .getIdentityNumber())
                              .build()
        );
                    ...
                    ParentDetails.builder()
                                 ...
                                 .fullName(registration.getStudent()
                                                       ...
                                                       .getFirstName() + " " + registration.getStudent()
                                                                                           .getMother()
                                                                                           .getLastName())
                                 .profession(registration.getStudent()
                                                         .getMother()
                                                         .getProfession())
                                 .phoneNumber(registration.getStudent()
                                                          .getMother()
                                 ...
                                 .email(registration.getStudent()
                                                    .getMother()
                                                    .getEmail())
                                 .isDeceased(registration.getStudent()
                                                         .getMother()
                                                         .getIsDeceased())
                                 .maritalStatus(registration.getStudent()
                                                            .getMother()
                                                            .getMaritalStatus())
                                 .build()
            );
        ...
        details.setAddress(
                Address.builder()
                       .city(registration.getStudent()
                                         .getAddress()
                                         .getCity())
                       .zipCode(registration.getStudent()
                                            .getAddress()
                                            .getZipCode())
                       .street(registration.getStudent()
                                           .getAddress()
                                           .getStreet())
                       .build()
        );
        ...
        registration.getRegistrationDocumentEntries()
                    .forEach(d -> {
                        DocumentRegistrationResponse doc = new DocumentRegistrationResponse();
                        doc.setId(d.getId());
                        doc.setDescription(d.getDocument()
                                            .getDescription());
                        doc.setName(d.getDocument()
                                     .getName());
                        documents.add(doc);
                    });
