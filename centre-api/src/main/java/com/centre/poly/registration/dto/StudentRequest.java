...
public record StudentRequest(
    ...
    @NotNull(message = "STUDENT_PHONE_NUMBER_REQUIRED")
        ...
        @Size(min = 8, max = 8, message = "STUDENT_PHONE_NUMBER_SIZE_MUST_BE_8")
        String phoneNumber,
    @Email(message = "STUDENT_EMAIL_NOT_VALID") String email,
    @NotNull(message = "STUDENT_LEVEL_OF_EDUCATION_REQUIRED")
        @NotEmpty(message = "STUDENT_LEVEL_OF_EDUCATION_REQUIRED")
        String levelOfEducation,
    String identityNumber,
    @NotNull(message = "STUDENT_BIRTH_DATE_REQUIRED") Date birthDate) {}
