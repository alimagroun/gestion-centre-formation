...
public class SchoolYearService {
    ...
    public PageResponse<SchoolYearResponse> findAllPagebale(int page, int size) {
        ...
        List<SchoolYearResponse> schoolYearResponses = pageSchoolYear.map(schoolYearMapper::toResponse)
                                                                     .toList();
        return new PageResponse<>(schoolYearResponses,
    ...
    public void toDefault(Long id) {
        ...
        SchoolYear schoolYearToDefault = schoolYearRepository.findById(id)
