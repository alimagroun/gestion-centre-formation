...
public class PersonController {
    ...
    public ResponseEntity<ParentResponse> findParentByNum(@RequestParam("num") String num, @RequestParam("type") ParentType type) {
        return ResponseEntity.ok()
                             .body(personService.findByPhoneNumberAndType(num, type));
    }
    ...
    public ResponseEntity<PageResponse<ParentResponse>> findAllParentsPaged(
        ...
        return ResponseEntity.ok()
                             .body(personService.findAllParentsPaged(page, size));
    }
    ...
    public ResponseEntity<PageResponse<StudentResponse>> findAllStudentsPaged(
            ...
            @RequestParam(name = "size",
                          ...
                          required = false) int size) {
        return ResponseEntity.ok()
                             .body(personService.findAllStudentsPaged(page, size));
    ...
    public ResponseEntity<StudentDetailsResponse> findStudentById(@PathVariable Long studentId) {
        return ResponseEntity.ok()
                             .body(personService.findStudentById(studentId));
    }
