...
public class ClassService {
    ...
    public Long saveAccreditedClass(AccreditedClassRequest request) {
        ...
        classeFormationRepository.findAccreditedClass(request.getSpecialtyId(),
        ...
        return classeFormationRepository.save(classMapper.toAccreditedClass(request))
                                        .getId();
    }
    ...
    public Long saveAcceleratedClass(AcceleratedClassRequest request) {
        ...
        classeFormationRepository.findAcceleratedClass(request.getSpecialtyId(),
                                                       request.getGroupNumber(),
        ...
        return classeFormationRepository.save(classMapper.toAcceleratedClass(request))
                                        .getId();
    }
    ...
    public PageResponse<AccreditedClassResponse> findAllAccreditedClass(int page, int size) {
        ...
        List<AccreditedClassResponse> list = classeFormationPage.stream()
                                                                .map(classMapper::toResponseAccreditedClass)
                                                                .toList();
        return new PageResponse<>(list,
                                  classeFormationPage.getNumber(),
                                  classeFormationPage.getSize(),
                                  classeFormationPage.getTotalElements(),
                                  classeFormationPage.getTotalPages(),
                                  classeFormationPage.isFirst(),
    ...
    public PageResponse<AcceleratedClassResponse> findAllAcceleratedClass(int page, int size) {
        ...
        List<AcceleratedClassResponse> list = classeFormationPage.stream()
                                                                 .map(classMapper::toResponseAccelerated)
                                                                 .toList();
        return new PageResponse<>(list,
                                  classeFormationPage.getNumber(),
                                  classeFormationPage.getSize(),
    ...
    public List<AcceleratedClass> findAll() {
        AcceleratedClass acceleratedClass = acceleratedClassRepository.findById(Long.valueOf(1))
                                                                      .orElseThrow(() -> new NotFoundException(
                                                                              "AcceleratedClass not found"));
    ...
    public List<ClassStudentResponse> findAllStudentByAcceleratedClassId(Long classId) {
        ...
        List<ClassStudentResponse> responses = entryList.stream()
                                                        .map(classMapper::toClassStudentResponse)
                                                        .toList();
        return responses;
    }
    ...
    public Long addStudentToAcceleratedClass(Long studentId, Long acceleratedClassId) {
        ...
        return acceleratedClassEntryRepository.save(classEntry)
                                              .getId();
    }
    ...
    public Long addStudentToAccreditClass(Long studentId, Long accreditClassId) {
        ...
        return accreditedClassEntryRepository.save(classEntry)
                                             .getId();
    }
